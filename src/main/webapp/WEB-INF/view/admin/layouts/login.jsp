...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/Admin/assets/css/font-awesome.css" />

<!-- text fonts -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/Admin/assets/css/ace-fonts.css" />

<!-- ace styles -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/Admin/assets/css/ace.css" />

<!--[if lte IE 9]>
			<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/Admin/assets/css/ace-part2.css" />
		<![endif]-->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/Admin/assets/css/ace-rtl.css" />
...
<body class="login-layout">
	...
	<script type="text/javascript">
		window.jQuery
				|| document.write("<script src='${pageContext.request.contextPath}/resources/Admin/assets/js/jquery.js'>"
						+ "<"+"/script>");
	</script>
...
<![endif]-->
	<script type="text/javascript">
		if ('ontouchstart' in document.documentElement)
			document
					.write("<script src='${pageContext.request.contextPath}/resources/Admin/assets/js/jquery.mobile.custom.js'>"
							+ "<"+"/script>");
	</script>
