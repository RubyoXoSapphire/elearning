...
<div class="page-header">
	<h1>
		List <small id="fuck"> <i
			class="ace-icon fa fa-angle-double-right"></i> Class
		</small>
	</h1>
</div>
<!-- /.page-header -->
	...
	<div class="row">
		<div class="col-xs-12">
			<button style="margin-left: 0" id="btnAdd" class="btn btn-info"
				...
				<i class="ace-icon fa fa-plus bigger-110"></i> Add Class
			</button>
		</div>
	</div>
	<div id="feedback"></div>
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div id="dynamic-table_filter" class="dataTables_filter">
					<label>Search:<input type="search" id="txtSearch"
			...
			<thead>
				<tr role="row">
					...
					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Domain: activate to sort column ascending">Class ID</th>

					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Subject</th>
					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Semester</th>
					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Teacher</th>
					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Stu's Quantity</th>
					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Begin - End Date</th>
...
jQuery(document).ready(function($) {
			   ...
			   <div class="modal-content">\
				<div class="modal-body">\
				 	<button type="button" class="close" data-dismiss="modal" style="margin-top:-10px;">&times;</button>\
						  ...
						  <span class="btn-danger" >'+ classid + '</span> ?\
					 </div>\
	...
	function ajaxData(){
		$.ajax({
			type : "POST",
			contentType : "application/json; charset=utf-8",
			url : "list-class/search?pagesize="+pagesize+"&pagenumber="+pagenumber,
				...
				'<tr role="row" class="even">\
					...
					<td>\
						<div class="hidden-sm hidden-xs action-buttons">\
							<a class="blue" href="edit-class-'+item.classId+'">\
								<i class="ace-icon fa fa-search-plus bigger-130"></i>\
							</a> <a class="green" href="edit-class-'+item.classId+'">\
								<i class="ace-icon fa fa-pencil bigger-130"></i>\
							</a> <a class="red deleterecord" href="#" data-id="'+item.classId+'">\
