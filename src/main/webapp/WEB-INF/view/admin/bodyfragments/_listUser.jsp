...
<div class="page-header">
	<h1>
		List <small id="fuck"> <i
			class="ace-icon fa fa-angle-double-right"></i> Admin
		</small>
	</h1>
</div>
<!-- /.page-header -->
			...
			<thead>
				<tr role="row">
					...
					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Domain: activate to sort column ascending">User
						ID</th>

					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">First
						Name</th>

					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Last
						Name</th>

					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Email</th>
					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Address</th>

					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Phone</th>

					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Role</th>

					<th class="hidden-480 sorting" tabindex="0"
						aria-controls="dynamic-table" rowspan="1" colspan="1"
						aria-label="Status: activate to sort column ascending">Sex</th>
...
jQuery(document).ready(function($) {
			   ...
			   <div class="modal-content">\
				<div class="modal-body">\
				 	<button type="button" class="close" data-dismiss="modal" style="margin-top:-10px;">&times;</button>\
						  ...
						  <span class="btn-danger" >'+ userid + '</span> ?\
					 </div>\
	...
	function ajaxData(){
		$.ajax({
			type : "POST",
			contentType : "application/json; charset=utf-8",
			url : "list-user/search?pagesize="+pagesize+"&pagenumber="+pagenumber,
				...
				'<tr role="row" class="even">\
					...
					<td>\
						<div class="hidden-sm hidden-xs action-buttons">\
							<a class="blue" href="edit-user-'+item.userId+'">\
								<i class="ace-icon fa fa-search-plus bigger-130"></i>\
							</a> <a class="green" href="edit-user-'+item.userId+'">\
								<i class="ace-icon fa fa-pencil bigger-130"></i>\
							</a> <a class="red deleterecord" href="#" data-id="'+item.userId+'">\
