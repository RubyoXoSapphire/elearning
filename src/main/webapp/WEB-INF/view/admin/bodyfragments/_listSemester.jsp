	...
	<div class="row">
		<div class="col-xs-12">
			<button style="margin-left: 0" id="btnAdd" class="btn btn-info"
				type="button" >
				<i class="ace-icon fa fa-plus bigger-110"></i> Add Semester
			</button>
		</div>
			...
			<div class="col-xs-6">
				<div id="dynamic-table_filter" class="dataTables_filter">
					<label>Search:<input type="text"
						...
						aria-controls="dynamic-table" id="txtSearch" ></label>
			...
			<thead>
				<tr role="row">
					...
					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Domain: activate to sort column ascending">Semester
						ID</th>

					<th class="sorting" tabindex="0" aria-controls="dynamic-table"
						rowspan="1" colspan="1"
						aria-label="Price: activate to sort column ascending">Name</th>
...
jQuery(document).ready(function($) {
	...
	function ajaxData(){
		$.ajax({
			...
			url : "list-semester/search?pagesize="+pagesize+"&pagenumber="+pagenumber,
		...
		for (var i=0;i<data.result.content.length;i++){
			...
			var display_data=
				'<tr role="row" class="even">\
					...
					<td><a href="#">'+item.semesterId+'</a></td>\
					<td>'+item.name+'</td>\
					<td class="hidden-480"><span\
						class="label label-sm label-'+(item.enabled?"success":"danger")+' ">'+(item.enabled?"Enabled":"Disabled")+'</span></td>\
					<td>\
						<div class="hidden-sm hidden-xs action-buttons">\
							<a class="blue" href="edit-semester-'+item.semesterId+'">\
								<i class="ace-icon fa fa-search-plus bigger-130"></i>\
							</a> <a class="green" href="edit-semester-'+item.semesterId+'">\
								<i class="ace-icon fa fa-pencil bigger-130"></i>\
							</a> <a class="red deleterecord" href="#" data-id="'+item.semesterId+'">\
						...
						<div class="hidden-md hidden-lg">\
							<div class="inline pos-rel">\
								...
								<ul\
									...
									<li><a href="edit-semester-'+item.semesterId+'" class="tooltip-info" data-rel="tooltip"\
										title="" data-original-title="View"> <span class="blue">\
												<i class="ace-icon fa fa-search-plus bigger-120"></i>\
										</span>\
									</a></li>\
									<li><a href="edit-semester-'+item.semesterId+'" class="tooltip-success"\
									...
									<li><a href="#" class="tooltip-error deleterecord" data-rel="tooltip"\
										title="" data-id="'+item.semesterId+'" data-original-title="Delete"> <span class="red">\
