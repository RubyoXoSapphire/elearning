<div id="sidebar" class="sidebar                  responsive"
	...
	<ul class="nav nav-list" style="top: 0px;">
		...
		<li class=""><a href="#" class="dropdown-toggle"> <i
			...
			<ul class="submenu">
				<li class=""><a href="list-answer"> <i
						class="menu-icon fa fa-caret-right"></i> Answer
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-answer-sheet"> <i
						class="menu-icon fa fa-caret-right"></i> Answer Sheet
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-answer-sheet-detail"> <i
						class="menu-icon fa fa-caret-right"></i> Answer Sheet Detail
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-chapter"> <i
						class="menu-icon fa fa-caret-right"></i> Chapter
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-class"> <i
						class="menu-icon fa fa-caret-right"></i> Class
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-exam"> <i
						class="menu-icon fa fa-caret-right"></i> Exam
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-question"> <i
						class="menu-icon fa fa-caret-right"></i> Question
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-role"> <i
						class="menu-icon fa fa-caret-right"></i> Role
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-semester"> <i
						class="menu-icon fa fa-caret-right"></i> Semester
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-subject"> <i
						class="menu-icon fa fa-caret-right"></i> Subject
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-type"> <i
						class="menu-icon fa fa-caret-right"></i> Type
				</a> <b class="arrow"></b></li>

				<li class=""><a href="list-user?pageNumber=0&pageSize=10&keyword=no">
