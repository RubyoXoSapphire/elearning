		...
		<div class="wrapper clearfix">
			<c:if test="${not empty message}">
				<div data-alert="alert"
					class="alert-message alert ${not empty hasError ? 'error' : 'success'}">
					<a
									...
									<li><strong>Text</strong>
										<ul class="menu level1">
											<li class="text hier"><a
												href="${pageContext.request.contextPath}/add-multichoice-question/${examId}">Multiple
													choice</a></li>
											<li class="fib"><a
					...
					<div class="col9">
						<div class="contentbox noLeftPadding">
							<form:form class="quizsettings" id="examquestionmodel"
								...
								action="${pageContext.request.contextPath}/add-question/${exam.examId}"
								method="post" modelAttribute="questionAndFourAnswerModel">
								<fieldset>
									<div class="richtextfield">
										<label for="ExamQuestionModel_question">Question <span
									...
									<div class="richtextfield">
										<label for="ExamQuestionModel_question">Chapter <span
											class="required">*</span></label> <select name="chapterId" >
									...
									<div class="richtextfield">
										<label for="ExamQuestionModel_question">Level <span
											class="required">*</span></label>
								...
								<fieldset class="createanswers">
									<div class="fieldgroup">
										<h2>Answer 1</h2>
										<div>
											<label for="ExamMultipleChoiseQuestionTypeModel_answer_1">Answer
										...
										<div class="radiobuttonfield" data-field="correct_1">
											<label> Correct Answer <form:radiobutton
													id="ExamMultipleChoiseQuestionTypeModel[correct_answer]"
													value="1" path="answer1.right" cssClass="radiobutton" />
											</label>
										</div>
									</div>
									<div class="fieldgroup">
										<h2>Answer 2</h2>
										<div>
											<label for="ExamMultipleChoiseQuestionTypeModel_answer_2">Answer
												<span class="required">*</span>
											</label>
											<form:textarea rows="8" cols="65"
												id="ExamQuestionModel_question"
										...
										<div class="radiobuttonfield" data-field="correct_2">
											<label> Correct Answer <form:radiobutton
													id="ExamMultipleChoiseQuestionTypeModel[correct_answer]"
													value="1" path="answer2.right" cssClass="radiobutton" />
											</label>
										</div>
									</div>
									<div class="fieldgroup">
										<h2>Answer 3</h2>
										<div>
											<label for="ExamMultipleChoiseQuestionTypeModel_answer_3">Answer
												<span class="required">*</span>
											</label>
											<form:textarea rows="8" cols="65"
												id="ExamQuestionModel_question"
										...
										<div class="radiobuttonfield" data-field="correct_3">
											<label> Correct Answer <form:radiobutton
													id="ExamMultipleChoiseQuestionTypeModel[correct_answer]"
													value="1" path="answer3.right" cssClass="radiobutton" />
											</label>
										</div>
									</div>
									<div class="fieldgroup">
										<h2>Answer 4</h2>
										<div>
											<label for="ExamMultipleChoiseQuestionTypeModel_answer_4">Answer
												<span class="required">*</span>
											</label>
											<form:textarea rows="8" cols="65"
												id="ExamQuestionModel_question"
										...
										<div class="radiobuttonfield" data-field="correct_4">
											<label> Correct Answer <form:radiobutton
													id="ExamMultipleChoiseQuestionTypeModel[correct_answer]"
													value="1" path="answer4.right" cssClass="radiobutton" />
											</label>
										</div>
									</div>
								</fieldset>
										...
										<div
											...
											<div class="fileinput-button">
												<input name="ExamQuestionModel[explanation_image]"
													...
													type="file" onclick="radioButtonEven()" />
												<p>
