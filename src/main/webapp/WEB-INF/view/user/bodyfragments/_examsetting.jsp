					...
					<div class="col9">
						<div class="contentbox noLeftPadding">
							<form:form class="quizsettings" id="exammodel"
								action="${pageContext.request.contextPath}/exam-setting/${exam.examId}"
									...
									<fieldset>
										...
										<div class="selectfield">
											...
											<div
												...
												<div class="errorMessage hide" id="ExamModel_subject">
													<form:errors path="subject" />
												</div>
											</div>
										</div>
										<div class="richtextfield">
											...
											<c:if test="${not empty exam.exam}">
												...
												<div class="errorMessage hide" id="ExamModel_title_em_"></div>
											</c:if>
											...
											<div class="errorMessage hide" id="ExamModel_intro_em_"></div>
										</div>
										<div class="richtextfield">
											<div class="tooltip popleft">
										...
										<div class="selectfield">
											...
											<div class="errorMessage hide" id="ExamModel_taal_em_"></div>
										</div>
										<div>
											<div class="tooltip popleft">
											...
											<div class="errorMessage hide"
												id="ExamModel_start_button_text_em_"></div>
										</div>
										...
										<div
											...
											<form:input placeholder="Exam mark_max"
												...
												type="number" maxlength="3" path="markMax" readonly="true"
												value="${totalMark}" />
											<div class="errorMessage hide" id="ExamModel_title_em_"
												style="display: block;">
												<form:errors path="markMax" />
										...
										<div class="selectfield">
											...
											<div class="errorMessage hide" id="ExamModel_type_em_"></div>
										</div>
										<div class="required">
											<div class="tooltip popleft">
											...
											<div class="errorMessage hide"
												id="ExamModel_number_of_attempts_em_"></div>
										</div>
										<div class="selectfield">
											<div class="tooltip popleft">
										...
										<div class="richtextfield">
											...
											<c:if test="${exam.enabled==2}">
												<div class="radiobuttonfield" data-field="correct_1">
													<form:hidden value="2" path="enabled" />
													<span class="" id="mylable"> <i class=""
														id="myglyphicon"></i> Selected
													</span>
												</div>
											</c:if>
