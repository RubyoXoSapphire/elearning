					...
					<div class="col3">
						<div class="contentbox">
							<strong class="heading h3"><a
								href="${pageContext.request.contextPath}/question-list">‹
					...
					<div class="col9">
						<div class="contentbox noLeftPadding">
							<form:form class="quizsettings" id="examquestionmodel"
								...
								action="${pageContext.request.contextPath}/add-multichoice-question/${exam.examId}"
								method="post" modelAttribute="questionAndFourAnswerModel">
								<fieldset>
									<div class="richtextfield">
										<input type="hidden" name="typeId" value="2" /> <label
											for="ExamQuestionModel_question">Question</label>
