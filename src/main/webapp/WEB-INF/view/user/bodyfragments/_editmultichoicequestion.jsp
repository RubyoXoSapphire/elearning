					...
					<div class="col3">
						<div class="contentbox">
							<strong class="heading h3"><a
								href="${pageContext.request.contextPath}/question-list/${exam.examId}">‹
									...
									<li><strong>Text</strong>
										<ul class="menu level1">
											<li class="text hier"><a
												href="${pageContext.request.contextPath}/add-multichoice-question/${exam.examId}">Multiple
													choice</a></li>
											<li class="fib"><a href="">Fill in the blanks</a></li>
											<li class="freeText"><a
												href="${pageContext.request.contextPath}/add-question-free-text/${exam.examId}">Free
													text</a></li>
										</ul></li>
									<li><strong>Image</strong>
										<ul class="menu level1">
											<li class="image"><a href="">One big image</a></li>
											<li class="smallImages"><a href="">Small images</a></li>
											<li class="mediumImages"><a href="">Medium images</a></li>
											<li class="largeImages"><a href="">Large images</a></li>
										</ul></li>
					...
					<div class="col9">
						<div class="contentbox noLeftPadding">
							<form:form class="quizsettings" id="examquestionmodel"
								...
								action="${pageContext.request.contextPath}/edit-multichoice-question/${examId}"
								...
								<fieldset>
									...
									<div class="richtextfield">
										<label for="ExamQuestionModel_question">Chapter</label> <select
											name="chapterId">
											<option
												value="${questionAndFourAnswerModel.question.chapter.chapterId}">${questionAndFourAnswerModel.question.chapter.name}</option>
											<option value="${question.chapter.chapterId}" readonly="true">------</option>
									...
									<div class="richtextfield">
										...
										<form:select path="question.questionLevel">
											<option
												value="${questionAndFourAnswerModel.question.questionLevel}">${questionAndFourAnswerModel.question.questionLevel}</option>
									...
									<div class="points required">
										<label for="ExamQuestionModel_points" class="required">Points&nbsp;<span
											class="required">*</span></label> <input name="mark" step="0.01"
											min="0" id="mark" type="number" value="${mark}" />
										<div class="errorMessage hide"
								...
								<fieldset>
									<div class="fieldgroup">
										<div>
											...
											<form:input placeholder="Media" path="question.mediaUrl" />
											<div class="errorMessage hide"
								...
								<fieldset class="createanswers">
									<div class="fieldgroup">
										...
										<div>
											...
											<form:input type="hidden" path="answer1.answerId"
										...
										<div class="radiobuttonfield" data-field="correct_1">
											<label> Correct Answer <form:checkbox
													path="answer1.right" />
											</label>
										</div>
									</div>
									<div class="fieldgroup">
										...
										<div>
											...
											<form:input type="hidden" path="answer2.answerId"
									...
									<div class="fieldgroup">
										...
										<div>
											...
											<form:input type="hidden" path="answer3.answerId"
									...
									<div class="fieldgroup">
										...
										<div>
											...
											<form:input type="hidden" path="answer4.answerId"
								...
								<form:input type="hidden" path="question.questionId" />
