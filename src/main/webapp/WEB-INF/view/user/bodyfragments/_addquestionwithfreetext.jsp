					...
					<div class="col9">
						<div class="contentbox noLeftPadding">
							<form:form class="quizsettings" id="examquestionmodel"
								...
								action="${pageContext.request.contextPath}/add-free-text-question/${exam.examId}"
								method="post" modelAttribute="question">
								<fieldset>
									<div class="richtextfield">
										<input type="hidden" name="typeId" value="3" /> <label
									...
									<div class="richtextfield">
										...
										<form:select path="questionLevel">
