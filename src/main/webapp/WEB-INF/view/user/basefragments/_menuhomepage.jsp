	...
	<div class="navbar mainnavbar">
		<div class="wrapper clearfix">
			<a class="qwlogo" href="${pageContext.request.contextPath}/home">
				...
				alt="Quizworks" /> <span>Top World University</span>
			</a>
				...
				<div class="col4 last">
					<div class="accountbar">
						<div class="loggedinas floatright dropdownify alignright">
							<strong class="dropdowntitle" id="dropdowntitle"> <security:authentication
									property="principal.username" />
							</strong>
							<ul class="dropdownblock hide">
								<li><a href="${pageContext.request.contextPath}/account"
									class="my-account">My account</a></li>
								<li><a class="logout"
			...
			<div class="row">
				...
				<div class="col4 last">
					<div class="accountbar loginregister alignright">
						<p>
							Join us now!
							<!-- <a href="#/create-an-account/item10053">Register</a>
...
<script>
	$(document).ready(function() {
		$("#account_menu").css("margin-right", "140px");
		$("#account_menu").hide();
